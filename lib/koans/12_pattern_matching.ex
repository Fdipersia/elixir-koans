defmodule PatternMatching do
  ...
  koan "The pattern can make assertions about what it expects" do
    assert match?([1, _second, _third], [1, "rice", 3])
  end
  ...
  koan "Errors returns are shaped differently than successful results" do
    dog = %{type: "dog", name: "Snoopy"}

    result =
      case Map.fetch(dog, :age) do
        {:ok, value} -> value
        :error -> "not present"
      end
